            ...
            if record.invoice_origin:
                ...
                for origin in origins:
                    ...
                    if origin.lower().startswith("so"):
                        ...
                        if sale_order.product_template_id:
                            if type(sale_order.product_template_id.name) == str:
                                if sale_order.product_template_id.name not in record.product_template:
                                    record.product_template += sale_order.product_template_id.name + " "
